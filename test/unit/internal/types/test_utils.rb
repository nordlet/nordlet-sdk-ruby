...
describe Nordlet::Internal::Types::Utils do
  Utils = Nordlet::Internal::Types::Utils

  module TestUtils
    class M < Nordlet::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Nordlet::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Nordlet::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Nordlet::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Nordlet::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises Nordlet::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = Nordlet::Internal::Types::Array[String]
      ModelArray = -> { Nordlet::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Nordlet::Internal::Types::Array[TestUtils::U] }
