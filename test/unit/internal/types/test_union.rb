...
describe Nordlet::Internal::Types::Union do
  class Rectangle < Nordlet::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Nordlet::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Nordlet::Internal::Types::Model
