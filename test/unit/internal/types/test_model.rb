...
describe Nordlet::Internal::Types::Model do
  ...
  class ExampleModel < Nordlet::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Nordlet::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Nordlet::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Nordlet::Internal::Types::Model
