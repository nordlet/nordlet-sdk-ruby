# Nordlet Ruby Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Nordlet%2FRuby)

The Nordlet Ruby library provides convenient access to the Nordlet APIs from Ruby.
...
nordlet = Nordlet::Client.new(
    base_url: Nordlet::Environment::PRODUCTION
)
```
...
rescue Nordlet::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue Nordlet::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue Nordlet::Errors::ApiError => e
