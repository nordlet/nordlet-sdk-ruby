...
require_relative "lib/nordlet/version"
...
Gem::Specification.new do |spec|
  spec.name = "nordlet"
  spec.authors = ["Nordlet"]
  spec.version = Nordlet::VERSION
  spec.summary = "Ruby client library for the Nordlet API"
  spec.description = "The Nordlet Ruby library provides convenient access to the Nordlet API from Ruby."
