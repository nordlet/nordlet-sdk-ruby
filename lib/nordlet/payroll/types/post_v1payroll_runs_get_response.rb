...
module Nordlet
  module Payroll
    module Types
      class PostV1PayrollRunsGetResponse < Internal::Types::Model
        ...
        field :status, -> { Nordlet::Payroll::Types::PostV1PayrollRunsGetResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Payroll::Types::PostV1PayrollRunsGetResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
