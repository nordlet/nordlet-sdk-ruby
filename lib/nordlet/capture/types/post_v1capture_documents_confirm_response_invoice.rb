...
module Nordlet
  module Capture
    module Types
      class PostV1CaptureDocumentsConfirmResponseInvoice < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Capture::Types::PostV1CaptureDocumentsConfirmResponseInvoiceType }, optional: false, nullable: false

        field :status, -> { Nordlet::Capture::Types::PostV1CaptureDocumentsConfirmResponseInvoiceStatus }, optional: false, nullable: false

        field :payment_status, -> { Nordlet::Capture::Types::PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus }, optional: false, nullable: false, api_name: "paymentStatus"
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Capture::Types::PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
