...
module Nordlet
  module Capture
    module Types
      class PostV1CaptureDocumentsExtractResponseExtraction < Internal::Types::Model
        field :supplier, -> { Nordlet::Capture::Types::PostV1CaptureDocumentsExtractResponseExtractionSupplier }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Capture::Types::PostV1CaptureDocumentsExtractResponseExtractionLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
