...
module Nordlet
  module Assets
    module Types
      class PostV1AssetsAssetsGetResponse < Internal::Types::Model
        ...
        field :status, -> { Nordlet::Assets::Types::PostV1AssetsAssetsGetResponseStatus }, optional: false, nullable: false
