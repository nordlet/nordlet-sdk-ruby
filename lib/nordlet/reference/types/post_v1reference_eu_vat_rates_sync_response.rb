...
module Nordlet
  module Reference
    module Types
      class PostV1ReferenceEuVatRatesSyncResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :situation_on, -> { String }, optional: false, nullable: false, api_name: "situationOn"

        field :status, -> { Nordlet::Reference::Types::PostV1ReferenceEuVatRatesSyncResponseStatus }, optional: false, nullable: false
