...
module Nordlet
  module Consolidation
    module Types
      class PostV1ConsolidationMembersAddResponse < Internal::Types::Model
        ...
        field :method_, -> { Nordlet::Consolidation::Types::PostV1ConsolidationMembersAddResponseMethod }, optional: false, nullable: false, api_name: "method"
      end
    end
  end
end
