...
module Nordlet
  module Bank
    module Types
      class PostV1BankTransactionsMatchResponse < Internal::Types::Model
        ...
        field :status, -> { Nordlet::Bank::Types::PostV1BankTransactionsMatchResponseStatus }, optional: false, nullable: false
