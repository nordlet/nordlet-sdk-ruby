...
module Nordlet
  module Bank
    module Types
      class PostV1BankSettlementsMatchResponse < Internal::Types::Model
        ...
        field :match_status, -> { Nordlet::Bank::Types::PostV1BankSettlementsMatchResponseMatchStatus }, optional: false, nullable: false, api_name: "matchStatus"
      end
    end
  end
end
