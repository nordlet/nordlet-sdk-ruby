...
module Nordlet
  module Bank
    module Types
      class PostV1BankSettlementsGetResponse < Internal::Types::Model
        ...
        field :status, -> { Nordlet::Bank::Types::PostV1BankSettlementsGetResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Bank::Types::PostV1BankSettlementsGetResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
