...
module Nordlet
  module Transport
    module Types
      class PostV1TransportWaybillsListResponseRowsItem < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :status, -> { Nordlet::Transport::Types::PostV1TransportWaybillsListResponseRowsItemStatus }, optional: false, nullable: false
