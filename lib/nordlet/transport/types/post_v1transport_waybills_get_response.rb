...
module Nordlet
  module Transport
    module Types
      class PostV1TransportWaybillsGetResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :status, -> { Nordlet::Transport::Types::PostV1TransportWaybillsGetResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Transport::Types::PostV1TransportWaybillsGetResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
