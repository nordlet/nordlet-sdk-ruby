...
module Nordlet
  module Transport
    module Types
      class PostV1TransportWaybillsCreateResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :status, -> { Nordlet::Transport::Types::PostV1TransportWaybillsCreateResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Transport::Types::PostV1TransportWaybillsCreateResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
