...
module Nordlet
  module Transport
    module Types
      class PostV1TransportWaybillsCancelResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :status, -> { Nordlet::Transport::Types::PostV1TransportWaybillsCancelResponseStatus }, optional: false, nullable: false
