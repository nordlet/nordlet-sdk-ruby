...
module Nordlet
  module Transport
    module Types
      class PostV1TransportWaybillsIssueResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :status, -> { Nordlet::Transport::Types::PostV1TransportWaybillsIssueResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Transport::Types::PostV1TransportWaybillsIssueResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
