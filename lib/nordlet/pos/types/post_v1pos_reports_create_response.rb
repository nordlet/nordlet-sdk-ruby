...
module Nordlet
  module Pos
    module Types
      class PostV1PosReportsCreateResponse < Internal::Types::Model
        ...
        field :vat_lines, -> { Internal::Types::Array[Nordlet::Pos::Types::PostV1PosReportsCreateResponseVatLinesItem] }, optional: false, nullable: false, api_name: "vatLines"
      end
    end
  end
end
