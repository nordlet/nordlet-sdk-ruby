...
module Nordlet
  module Declarations
    module Types
      class PostV1DeclarationsEuOssComputeResponseRowsItem < Internal::Types::Model
        field :country_code, -> { String }, optional: false, nullable: false, api_name: "countryCode"

        field :rate_type, -> { Nordlet::Declarations::Types::PostV1DeclarationsEuOssComputeResponseRowsItemRateType }, optional: false, nullable: false, api_name: "rateType"
