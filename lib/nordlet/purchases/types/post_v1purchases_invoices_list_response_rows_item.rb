...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesInvoicesListResponseRowsItem < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesListResponseRowsItemType }, optional: false, nullable: false

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesListResponseRowsItemStatus }, optional: false, nullable: false

        field :payment_status, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesListResponseRowsItemPaymentStatus }, optional: false, nullable: false, api_name: "paymentStatus"
