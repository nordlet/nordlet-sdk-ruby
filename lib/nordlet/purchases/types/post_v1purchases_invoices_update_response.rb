...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesInvoicesUpdateResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesUpdateResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesUpdateResponseStatus }, optional: false, nullable: false

        field :payment_status, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesUpdateResponsePaymentStatus }, optional: false, nullable: false, api_name: "paymentStatus"
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Purchases::Types::PostV1PurchasesInvoicesUpdateResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
