...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesOrdersCancelResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesOrdersCancelResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Purchases::Types::PostV1PurchasesOrdersCancelResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
