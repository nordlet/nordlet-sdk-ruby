...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesInvoicesRegisterResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesRegisterResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesRegisterResponseStatus }, optional: false, nullable: false

        field :payment_status, -> { Nordlet::Purchases::Types::PostV1PurchasesInvoicesRegisterResponsePaymentStatus }, optional: false, nullable: false, api_name: "paymentStatus"
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Purchases::Types::PostV1PurchasesInvoicesRegisterResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
