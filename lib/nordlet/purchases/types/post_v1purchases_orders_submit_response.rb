...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesOrdersSubmitResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesOrdersSubmitResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Purchases::Types::PostV1PurchasesOrdersSubmitResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
