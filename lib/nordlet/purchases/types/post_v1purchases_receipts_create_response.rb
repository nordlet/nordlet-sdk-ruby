...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesReceiptsCreateResponse < Internal::Types::Model
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Purchases::Types::PostV1PurchasesReceiptsCreateResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
