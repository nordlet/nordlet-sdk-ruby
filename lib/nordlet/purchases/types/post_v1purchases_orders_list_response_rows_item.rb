...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesOrdersListResponseRowsItem < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesOrdersListResponseRowsItemStatus }, optional: false, nullable: false
