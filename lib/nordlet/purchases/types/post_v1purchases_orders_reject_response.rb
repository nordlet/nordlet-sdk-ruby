...
module Nordlet
  module Purchases
    module Types
      class PostV1PurchasesOrdersRejectResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :status, -> { Nordlet::Purchases::Types::PostV1PurchasesOrdersRejectResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Purchases::Types::PostV1PurchasesOrdersRejectResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
