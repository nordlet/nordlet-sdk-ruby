...
module Nordlet
  module Agreements
    module Types
      class PostV1AgreementsAgreementsUpdateResponse < Internal::Types::Model
        ...
        field :items, -> { Internal::Types::Array[Nordlet::Agreements::Types::PostV1AgreementsAgreementsUpdateResponseItemsItem] }, optional: false, nullable: false
      end
    end
  end
end
