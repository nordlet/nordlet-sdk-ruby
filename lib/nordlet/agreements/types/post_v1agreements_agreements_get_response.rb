...
module Nordlet
  module Agreements
    module Types
      class PostV1AgreementsAgreementsGetResponse < Internal::Types::Model
        ...
        field :items, -> { Internal::Types::Array[Nordlet::Agreements::Types::PostV1AgreementsAgreementsGetResponseItemsItem] }, optional: false, nullable: false
      end
    end
  end
end
