...
module Nordlet
  module Partners
    module Types
      class PostV1PartnersFindOrCreateRequest < Internal::Types::Model
        field :type, -> { Nordlet::Partners::Types::PostV1PartnersFindOrCreateRequestType }, optional: true, nullable: false
