...
module Nordlet
  module Production
    module Types
      class PostV1ProductionMaintenanceCreateResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :work_center_id, -> { String }, optional: false, nullable: false, api_name: "workCenterId"

        field :type, -> { Nordlet::Production::Types::PostV1ProductionMaintenanceCreateResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Production::Types::PostV1ProductionMaintenanceCreateResponseStatus }, optional: false, nullable: false
