...
module Nordlet
  module Production
    module Types
      class PostV1ProductionBomsCreateResponse < Internal::Types::Model
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Production::Types::PostV1ProductionBomsCreateResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
