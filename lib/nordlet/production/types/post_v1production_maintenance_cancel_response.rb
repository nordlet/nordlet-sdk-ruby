...
module Nordlet
  module Production
    module Types
      class PostV1ProductionMaintenanceCancelResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :work_center_id, -> { String }, optional: false, nullable: false, api_name: "workCenterId"

        field :type, -> { Nordlet::Production::Types::PostV1ProductionMaintenanceCancelResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Production::Types::PostV1ProductionMaintenanceCancelResponseStatus }, optional: false, nullable: false
