  ...
  module Production
    module Types
      class PostV1ProductionOrdersGetResponse < Internal::Types::Model
        ...
        field :operations, -> { Internal::Types::Array[Nordlet::Production::Types::PostV1ProductionOrdersGetResponseOperationsItem] }, optional: false, nullable: false

        field :quality_checks, -> { Internal::Types::Array[Nordlet::Production::Types::PostV1ProductionOrdersGetResponseQualityChecksItem] }, optional: false, nullable: false, api_name: "qualityChecks"
      end
    end
  end
end
