...
module Nordlet
  module Production
    module Types
      class PostV1ProductionMaintenanceListResponseRowsItem < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :work_center_id, -> { String }, optional: false, nullable: false, api_name: "workCenterId"

        field :type, -> { Nordlet::Production::Types::PostV1ProductionMaintenanceListResponseRowsItemType }, optional: false, nullable: false

        field :status, -> { Nordlet::Production::Types::PostV1ProductionMaintenanceListResponseRowsItemStatus }, optional: false, nullable: false
