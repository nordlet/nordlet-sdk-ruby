...
module Nordlet
  module Hr
    module Types
      class PostV1HrEmployeesUpdateRequest < Internal::Types::Model
        ...
        field :address, -> { Nordlet::Hr::Types::PostV1HrEmployeesUpdateRequestAddress }, optional: true, nullable: false
        ...
        field :status, -> { Nordlet::Hr::Types::PostV1HrEmployeesUpdateRequestStatus }, optional: true, nullable: false
      end
    end
  end
end
