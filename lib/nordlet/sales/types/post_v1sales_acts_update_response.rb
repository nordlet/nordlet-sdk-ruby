...
module Nordlet
  module Sales
    module Types
      class PostV1SalesActsUpdateResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Sales::Types::PostV1SalesActsUpdateResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Sales::Types::PostV1SalesActsUpdateResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Sales::Types::PostV1SalesActsUpdateResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
