...
module Nordlet
  module Sales
    module Types
      class PostV1SalesActsIssueResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Sales::Types::PostV1SalesActsIssueResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Sales::Types::PostV1SalesActsIssueResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Sales::Types::PostV1SalesActsIssueResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
