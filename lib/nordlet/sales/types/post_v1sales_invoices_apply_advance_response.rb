...
module Nordlet
  module Sales
    module Types
      class PostV1SalesInvoicesApplyAdvanceResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Sales::Types::PostV1SalesInvoicesApplyAdvanceResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Sales::Types::PostV1SalesInvoicesApplyAdvanceResponseStatus }, optional: false, nullable: false

        field :payment_status, -> { Nordlet::Sales::Types::PostV1SalesInvoicesApplyAdvanceResponsePaymentStatus }, optional: false, nullable: false, api_name: "paymentStatus"
        ...
        field :vat_scheme, -> { Nordlet::Sales::Types::PostV1SalesInvoicesApplyAdvanceResponseVatScheme }, optional: false, nullable: true, api_name: "vatScheme"
