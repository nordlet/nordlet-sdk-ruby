...
module Nordlet
  module Sales
    module Types
      class PostV1SalesInvoicesCreateResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Sales::Types::PostV1SalesInvoicesCreateResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Sales::Types::PostV1SalesInvoicesCreateResponseStatus }, optional: false, nullable: false

        field :payment_status, -> { Nordlet::Sales::Types::PostV1SalesInvoicesCreateResponsePaymentStatus }, optional: false, nullable: false, api_name: "paymentStatus"
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Sales::Types::PostV1SalesInvoicesCreateResponseLinesItem] }, optional: false, nullable: false

        field :vat_evidence, -> { Nordlet::Sales::Types::PostV1SalesInvoicesCreateResponseVatEvidence }, optional: false, nullable: true, api_name: "vatEvidence"
      end
    end
  end
end
