...
module Nordlet
  module Sales
    module Types
      class PostV1SalesActsCreateResponse < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Sales::Types::PostV1SalesActsCreateResponseType }, optional: false, nullable: false

        field :status, -> { Nordlet::Sales::Types::PostV1SalesActsCreateResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Sales::Types::PostV1SalesActsCreateResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
