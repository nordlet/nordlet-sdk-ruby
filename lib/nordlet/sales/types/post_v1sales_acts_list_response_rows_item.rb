...
module Nordlet
  module Sales
    module Types
      class PostV1SalesActsListResponseRowsItem < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false

        field :partner_id, -> { String }, optional: false, nullable: false, api_name: "partnerId"

        field :type, -> { Nordlet::Sales::Types::PostV1SalesActsListResponseRowsItemType }, optional: false, nullable: false

        field :status, -> { Nordlet::Sales::Types::PostV1SalesActsListResponseRowsItemStatus }, optional: false, nullable: false
