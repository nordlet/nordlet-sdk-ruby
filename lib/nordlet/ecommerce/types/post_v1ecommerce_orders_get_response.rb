...
module Nordlet
  module Ecommerce
    module Types
      class PostV1EcommerceOrdersGetResponse < Internal::Types::Model
        ...
        field :status, -> { Nordlet::Ecommerce::Types::PostV1EcommerceOrdersGetResponseStatus }, optional: false, nullable: false
        ...
        field :lines, -> { Internal::Types::Array[Nordlet::Ecommerce::Types::PostV1EcommerceOrdersGetResponseLinesItem] }, optional: false, nullable: false
      end
    end
  end
end
